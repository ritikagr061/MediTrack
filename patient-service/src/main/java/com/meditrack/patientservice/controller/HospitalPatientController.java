...
public class HospitalPatientController {
    ...
    public HospitalPatientController(PatientService patientService, AuthContext authContext) {
    ...
    public ResponseEntity<Page<PatientResponseDTO>> getHospitalPatients(
        ...
        return ResponseEntity.ok(
                patientService.getPatients(search, authContext.scopedHospitalId(hospitalId), isActive, page, size, sortBy, sortDirection)
        );
    }
}
